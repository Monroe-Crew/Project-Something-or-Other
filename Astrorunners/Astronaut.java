    ...
    public void act() {
        ...
        if(blackholes.size() > 0) {
            ...
            if(!feetOnGround()){
                ...
                //velocityX += 50*(Math.cos(Math.toRadians(rotation)) / (Math.log(Distance) / Math.log(2)));
                //velocityY += 50*(Math.sin(Math.toRadians(rotation)) / (Math.log(Distance) / Math.log(2)));
            }
        ...
        if(blackholes.size() > 0){
            if(LB.size() > 0){
                ...
                while(BL.size() > 0) {
                    ...
                    velocityY *= Math.cos(Math.toRadians(BL.get(0).getRotation())) * -10;
                    velocityX *= Math.sin(Math.toRadians(BL.get(0).getRotation()-180)) * -10;
                ...
                while(BR.size() > 0) {
                    ...
                    velocityY *= Math.cos(Math.toRadians(BR.get(0).getRotation())) * -10;
                    velocityX *= Math.sin(Math.toRadians(BR.get(0).getRotation()-180)) * -10;
